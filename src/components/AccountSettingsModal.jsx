      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-800 font-medium mt-1">{formData.country}</p>
          )}
        </div>
        <div>
          ...
          {isEditing ? (
            ...
            <p className="text-gray-800 font-medium mt-1">{formData.phoneNumber}</p>
          )}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex justify-center items-center p-4 overflow-auto">
      <div className="bg-white w-full max-w-4xl rounded-2xl shadow-xl p-6 relative animate-fade-in-up h-[90vh] flex flex-col">
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-gray-400 hover:text-red-500 z-20"
        >
          ...
          <div className="bg-white border-b md:border-b-0 md:border-r p-2 flex md:flex-col space-x-2 md:space-x-0 md:space-y-3 overflow-x-auto md:overflow-y-auto w-full md:w-1/4">
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-green-50 ${
                activeTab === "profile" ? "bg-green-100 font-semibold" : ""
              }`}
            >
              <FaUser /> Profile
            </button>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-md hover:bg-green-50 ${
                activeTab === "preference" ? "bg-green-100 font-semibold" : ""
              }`}
            >
              <FaCog /> Preferences
            </button>
