...
function SomaliIntermediate() {
const level = "Dhexdhexaad (Intermediate)";
  ...
  snap.forEach((doc) => {
    const data = doc.data();
    if (data.grade === "Dhexdhexaad (Intermediate)" && data.curriculum === "Somali Course") {
...
export default SomaliIntermediate;
